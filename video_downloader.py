...
import logging
logging.basicConfig(filename='logs/download_{}.log'.format(int(time.time())), filemode='w', level=logging.DEBUG)
...
def download_nonyt_videos(indexfile, saveto='raw_videos'):
    ...
    for entry in content:
        ...
        logging.info('video_url: {}, video_id: {}.'.format(video_url, video_id))
...
if __name__ == '__main__':
    ...
    successful_train, unsuccessful_train = download_yt_videos('MSASL_train.json', 'train')
    successful_test, unsuccessful_test = download_yt_videos('MSASL_test.json', 'test')
    successful_val, unsuccessful_val = download_yt_videos('MSASL_val.json', 'val')

    print("train", successful_train, unsuccessful_train, successful_train / (successful_train + unsuccessful_train))
    print("test", successful_test, unsuccessful_test, successful_test / (successful_test + unsuccessful_test))
    print("val", successful_val, unsuccessful_val, successful_val / (successful_val + unsuccessful_val))
