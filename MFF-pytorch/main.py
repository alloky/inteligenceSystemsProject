...
def main():
    ...
    num_class = 100
    prefix = '{}.jpg'
    train_ds_path = r'/home/mlepekhin/train_frames_big'
    valid_ds_path = r'/home/mlepekhin/test_frames_big'
    train_list_path = r'/home/ariashchikov/MFF-pytorch/train_records.txt'
    valid_list_path = r'/home/ariashchikov/MFF-pytorch/test_records.txt'

    args.store_name = '_'.join(['MFF', 'msasl', args.modality, args.arch,
    ...
    train_loader = torch.utils.data.DataLoader(
        TSNDataSet(train_ds_path, train_list_path, num_segments=args.num_segments,
    ...
    val_loader = torch.utils.data.DataLoader(
        TSNDataSet(valid_ds_path, valid_list_path, num_segments=args.num_segments,
                   new_length=data_length,
                   modality=args.modality,
                   image_tmpl=prefix,
                   dataset=args.dataset,
